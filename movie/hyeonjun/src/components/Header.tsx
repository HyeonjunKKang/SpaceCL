    ...
    <div className="flex h-[50px] items-center justify-between px-3 bg-black">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex gap-1 items-center">
          <Link to={'/login'} className="bg-purple-400 px-1 text-white text-[15px] rounded-[3px]">
            로그인
          </Link>
          <Link to={'/signup'} className="bg-purple-400 px-1 text-white text-[15px] rounded-[3px]">
            회원가입
          </Link>
        </div>
      </div>
